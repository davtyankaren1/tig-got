...
//     id: 1,
//     image: "/hero-1.png",
//     title: "Բարի գալուստ ՏԻԳ-ԳՈՌ",
//     subtitle: "Համով շաուրմա՝ բնական բաղադրիչներով և սիրով պատրաստված"
//   },
//   {
//     id: 2,
//     image: "/hero-2.png",
//     title: "Անմահական քյաբաբ",
//     subtitle: "Թարմ միս և ավանդական բաղադրատոմսերով պատրաստված քյաբաբներ"
//   },
//   {
//     id: 3,
//     image: "/hero-3.png",
//     title: "Թոնրի Խորոված",
//     subtitle: "Թոնրի խորոված՝ իսկական հայկական ձևով"
//   }
// ];
...
//             <div
//               className='absolute top-3/8 left-1/5 w-1 h-1 bg-white/80 rounded-full float-random-1'
...
//             ></div>
//             <div
//               className='absolute bottom-7/8 right-3/5 w-1 h-1 bg-white/60 rounded-full float-random-2'
...
//             ></div>
//             <div
//               className='absolute bottom-1/12 right-1/12 w-2 h-2 bg-white/55 rounded-full float-random-3'
...
//             <div
//               className='absolute bottom-1/5 left-1/5 w-4 h-4 bg-white/35 rounded-full blur-sm float-random-1'
//               style={{ animationDelay: "1.5s" }}
//             ></div>
//             <div
...
//             <div
//               className='absolute top-2/5 left-4/5 w-1 h-1 bg-white/75 rounded-full float-random-2'
...
//             ></div>
//             <div
//               className='absolute bottom-4/5 right-2/5 w-1 h-1 bg-white/70 rounded-full float-random-3'
...
//             ></div>
//             <div
//               className='absolute bottom-2/7 right-5/7 w-0.5 h-0.5 bg-white/75 rounded-full float-random-1'
...
//           className='border border-white/30 z-10  absolute  left-4 lg:left-8 top-1/2 transform -translate-y-1/2 bg-white/10 text-white borderz-10'
//         >
//           <ChevronLeft className='h-2 w-2' size={30} />
//         </Button>
...
//           size='icon'
//           onClick={goToNext}
//           className='border border-white/30 z-10  absolute  right-4 lg:right-8 top-1/2 transform -translate-y-1/2 bg-white/10 text-white borderz-10'
//         >
...
//             size='icon'
//             onClick={goToPrevious}
//             className='bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-sm w-12 h-12'
//           >
    ...
    <>
      ...
      >
        ...
        <Button
          ...
          size='icon'
          onClick={goToPrevious}
          className='hidden lg:block absolute left-4 lg:left-8 top-1/2 transform -translate-y-1/2 bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-sm z-10'
        >
        ...
        <Button
          ...
          size='icon'
          onClick={goToNext}
          className='hidden lg:block absolute right-4 lg:right-8 top-1/2 transform -translate-y-1/2 bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-sm z-10'
        >
